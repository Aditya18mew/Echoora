...
export function Navbar({Name,username,image}:data){
  ...
  <div className="flex items-center gap-4">
    ...
    <Link href={`/profile/${username}`} className="flex items-center p-1 justify-between gap-2 w-auto h-10 rounded-3xl border border-gray-500 bg-[#1f242f] hover:border-purple-500 cursor-pointer transition">
